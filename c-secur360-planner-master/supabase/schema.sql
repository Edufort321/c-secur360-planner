...
CREATE TABLE IF NOT EXISTS personnel (
  ...
  departement TEXT,
  succursale TEXT,
  password TEXT, -- Mot de passe (à hasher en prod)
...
-- Vue: Personnel avec leur succursale complète
...
INSERT INTO succursales (nom, ville, couleur) VALUES
  ...
  ('C-Secur360 Montréal', 'Montréal', '#DC2626'),
  ('C-Secur360 Québec', 'Québec', '#059669')
